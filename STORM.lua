...
sudo_users = {SUDO,1428944400,1566031059,1033028167}   
...
if hash or SudoBot(msg) or DevSTORMW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevSTORMW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevSTORMW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevSTORMW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevSTORMW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevSTORMW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevSTORMW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1428944400) then  
var = true  
...
local UserName = (data.username_ or "A_U888")
...
local STORM_Msg = ''  
if msgs < 100 then 
STORM_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
STORM_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
STORM_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
STORM_Msg = 'متفاعل' 
elseif msgs < 1200 then 
STORM_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
STORM_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
STORM_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
STORM_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
STORM_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
STORM_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
STORM_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
STORM_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
STORM_Msg = 'رب التفاعل'  
end 
return STORM_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceSTORM(msg,data) -- بداية العمل
if msg then
...
SourceSTORMr = '⎗ اهلا عزيزي\n ⎗ انا بوت اسمي '..Namebot..'\n ⎗ اختصاصي حمايه الكروبات\n ⎗ من تكرار والسبام والتوجيه والخ…\n ⎗ لتفعيلي اتبع الاخطوات…↓\n ⎗ اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[ ⎗ [قناة سورس البوت](http://t.me/A_U888)'
end 
send(msg.chat_id_, msg.id_, SourceSTORMr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevSTORMW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevSTORMW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,STORM_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ⎗' and DevSTORMW(msg) then  
...
if text == 'تعطيل التواصل ⎗' and DevSTORMW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⎗' and DevSTORMW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⎗' and DevSTORMW(msg) then  
...
if text == 'ضع كليشه ستارت ⎗' and DevSTORMW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ⎗ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ⎗' and DevSTORMW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ⎗ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ⎗' and DevSTORMW(msg) then 
...
if text == 'تحديث السورس ⎗' and DevSTORMW(msg) then 
os.execute('rm -rf STORM.lua')
os.execute('wget https://raw.githubusercontent.com/STORMMTEAM/STORM/main/STORM.lua')
send(msg.chat_id_, msg.id_,' ⎗ تم تحديث السورس \n ⎗ لديك اخر اصدار لسورس ستورم\n ⎗ الاصدار » { 1.3v}')
dofile('STORM.lua')  
end
if text == 'الاصدار ⎗' and DevSTORMW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⎗ اصدار سورس ستورم \n ⎗ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ⎗' and DevSTORMW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⎗ [تحديثات البوت](t.me/S_X_X_C) \n ⎗ [قناه السورس](t.me/A_U888)')
end
if text == "ضع اسم للبوت ⎗" and DevSTORMW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ⎗ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ⎗' and DevSTORMW(msg) then 
...
if text == 'المشتركين ⎗' and DevSTORMW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ⎗ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⎗' and DevSTORMW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ⎗ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⎗") and DevSTORMW(msg) then
...
if text == ("قائمه العام ⎗") and DevSTORMW(msg) then
...
if text == ("قائمه الكتم العام ⎗") and DevSTORMW(msg) then
...
if text=="اذاعه خاص ⎗" and msg.reply_to_message_id_ == 0 and DevSTORMW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⎗ ارسل الان اذاعتك؟ \n ⎗ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ⎗" and msg.reply_to_message_id_ == 0 and DevSTORMW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⎗ ارسل الان اذاعتك؟ \n ⎗ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ⎗" and msg.reply_to_message_id_ == 0 and DevSTORMW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⎗ ارسل الان اذاعتك؟ \n ⎗ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ⎗" and msg.reply_to_message_id_ == 0  and DevSTORMW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⎗ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ⎗" and msg.reply_to_message_id_ == 0  and DevSTORMW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⎗ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⎗' and DevSTORMW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⎗" and DevSTORMW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ⎗" and DevSTORMW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'⎗  عدد الكروبات الان » { '..#group..' }'..STORMk..''..STORM..'\n⎗  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevSTORMW(msg) then
...
usertext = '\n ⎗ العضو » ['..result.title_..'](t.me/'..(username or 'A_U888')..')'
status  = '\n ⎗ تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevSTORMW(msg) then
...
usertext = '\n ⎗ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'A_U888')..')'
status  = '\n ⎗ تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevSTORMW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevSTORMW(msg) then
...
local STORM1_Msg = database:get(bot_id.."STORM1:Add:Filter:Rp2"..text..msg.chat_id_)   
if STORM1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⎗ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'A_U888')..') \n ⎗ '..STORM1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if STORM_Msg and not Special(msg) then  
local STORM_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if STORM_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ⎗ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ⎗ ["..STORM_Msg.."] \n")
else
send(msg.chat_id_,0," ⎗ العضو : {["..data.first_name_.."](T.ME/A_U888)}\n ⎗ ["..STORM_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ⎗ عذرا » {["..data.first_name_.."](T.ME/A_U888)}\n ⎗ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevSTORMW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevSTORMW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevSTORMW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ⎗ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevSTORMW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ⎗ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ⎗" and DevSTORMW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ⎗ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⎗$") and DevSTORMW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ⎗ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⎗" and DevSTORMW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ⎗" and DevSTORMW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ⎗ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ⎗" and DevSTORMW(msg) then  
...
database:sadd(bot_id.."STORM:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."STORM:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_STORM = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_STORM then 
names_STORM = database:smembers(bot_id.."STORM:blocname"..msg.chat_id_) or ""
if names_STORM and names_STORM[1] then 
for i=1,#names_STORM do 
if name_STORM:match("(.*)("..names_STORM[i]..")(.*)") then 
...
database:set(bot_id.."STORM:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."STORM:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."STORM:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."STORM:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."STORM:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_STORMa_new(STORM1,STORM2)
if STORM2 and STORM2.first_name_ then 
if STORM2.first_name_:match("(.*)"..database:get(bot_id.."STORM:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."STORM:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local STORM_nnn = database:get(bot_id.."STORM:nump"..msg.chat_id_) or 5
local STORM_nnn2 = database:get(bot_id.."STORM:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(STORM_nnn2) == tonumber(STORM_nnn) or tonumber(STORM_nnn2) > tonumber(STORM_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."STORM:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⎗ عزيزي >>["..STORM2.username_.."](https://t.me/"..(STORM2.username_ or "A_U888")..")\n⎗ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."STORM:teh"..msg.chat_id_).."} بجانب اسمك\n⎗ عدد المحاولات المتبقيه {"..(tonumber(STORM_nnn) - tonumber(STORM_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_STORMa_new)
end
end
...
local STORMChengName = database:get(bot_id.."STORM:Cheng:Name"..data.id_)
if not data.first_name_ then 
if STORMChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..STORMChengName..']')
database:del(bot_id.."STORM:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if STORMChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."STORM:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local STORMChengUserName = database:get(bot_id.."STORM:Cheng:UserName"..data.id_)
if not data.username_ then 
if STORMChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..STORMChengUserName..']')
database:del(bot_id.."STORM:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if STORMChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."STORM:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local STORMChengPhoto = database:get(bot_id.."STORM:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if STORMChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."STORM:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if STORMChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."STORM:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
⍆══◓═══𝗦𝗧══◓═══⍅
 ⎗ ↬𝗦𝗧𝗢𝗥𝗠 𝙏𝙀𝘼𝙈
⍆══◓═══𝗦𝗧══◓═══⍅
 ⎗ ↬[Developer STORM](t.me/A_U888) 
⍆══◓═══𝗦𝗧══◓═══⍅
 ⎗ ↬[Developer](t.me/S_X_X_C)
⍆══◓═══𝗦𝗧══◓═══⍅
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if text == 'رفع نسخه الاحتياطيه' and DevSTORMW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ⎗ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'A_U888')..') \n ⎗ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⎗ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'A_U888')..') \n ⎗ تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevSTORMW(msg) then    
dofile('STORM.lua')  
send(msg.chat_id_, msg.id_, ' ⎗ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevSTORMW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevSTORMW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevSTORMW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevSTORMW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevSTORMW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevSTORMW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevSTORMW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevSTORMW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevSTORMW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevSTORMW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevSTORMW(msg) then
...
if text == ("رفع مطور") and msg.reply_to_message_id_ and DevSTORMW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevSTORMW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "A_U888")
...
function Function_STORM(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_STORM, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_STORM, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ⎗ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'A_U888')..')'
status  = '\n ⎗ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ⎗ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ⎗ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'A_U888')..')'
...
database:set(bot_id.."STORM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."STORM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ⎗ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."STORM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."STORM1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."STORM1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."STORM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ⎗ تم منع الكلمه مع التحذير")  
database:del(bot_id.."STORM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."STORM1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."STORM1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."STORM1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ⎗ ارسل الكلمه الان")  
database:set(bot_id.."STORM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."STORM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."STORM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."STORM1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."STORM1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."STORM1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."STORM1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."STORM1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."STORM1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ⎗ قائمة المنع \n⍆══◓═══𝗦𝗧══◓═══⍅\n"
for k,v in pairs(list) do  
local STORM_Msg = database:get(bot_id.."STORM1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..STORM_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevSTORMW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ⎗ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevSTORMW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ⎗ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'A_U888')..')'..'\n ⎗ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevSTORMW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevSTORMW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ستورم').."" then  
...
send(msg.chat_id_, msg.id_,'['..STORM_Msg[math.random(#STORM_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevSTORMW(msg) then 
...
if text == ("مسح ردود المطور") and DevSTORMW(msg) then 
...
if text == ("ردود المطور") and DevSTORMW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⎗ قائمة ردود المطور \n⍆══◓═══𝗦𝗧══◓═══⍅\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevSTORMW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevSTORMW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ستورم').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevSTORMW(msg) then   
...
if text == 'تعطيل المغادره' and DevSTORMW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'A_U888')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
STORMdx(msg.chat_id_, msg.id_, ' ⎗ ايدي المجموعة » ( '..msg.chat_id_..' )\n ⎗ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ⎗ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ⎗ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevSTORMW(msg) then
...
send(msg.chat_id_, msg.id_, t..'ٴ⎗ٴ⍆══◓═══𝗦𝗧══◓═══⍅ٴ⎗○ٴ\n⎗ 彡 .[𝗦𝗧𝗢𝗥𝗠 𝙏𝙀𝘼𝙈](t.me/A_U888)➢ ')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ستورم')
...
STORM = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(STORM)
...
--------------------------------------------------------------------------------------------------------------
SourceSTORM(data.message_,data)
...
------------------------------------------------------------------------
local STORMAbot = database:get(bot_id.."STORM1:Add:Filter:Rp2"..text..result.chat_id_)   
if STORMAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ⎗ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ⎗ ["..STORMAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local STORM1_Msg = database:get(bot_id.."STORM1:Add:Filter:Rp2"..text..result.chat_id_)   
if STORM1_Msg then    
send(msg.chat_id_, msg.id_," ⎗ "..STORM1_Msg)
